...
export default function NetworkScreens() {
  ...
  const handleDeleteScreen = async () => {
    ...
    if (!id) return;
    try {
      await client.delete(`/master/screens/${id}`);
  ...
  return (
    <>
                ...
                <div style={{ position: 'relative', marginLeft: '0.5rem' }}>
                  ...
                  {activeMenuId === screen.id && (
                    <div style={{
                      ...
                      <button 
                        onClick={() => { setActiveMenuId(null); setDeleteConfirm({ isOpen: true, id: screen.id }); }}
                        style={{
                          width: '100%',
      ...
      <ConfirmModal 
        ...
        title="Delete Screen?"
        message="Are you sure you want to delete this screen? This will remove it from all campaigns."
